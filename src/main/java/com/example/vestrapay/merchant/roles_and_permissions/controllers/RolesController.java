package com.example.vestrapay.merchant.roles_and_permissions.controllers;
...
import com.example.vestrapay.merchant.roles_and_permissions.services.PermissionService;
import com.example.vestrapay.merchant.roles_and_permissions.services.RoleService;
...
//    @PreAuthorize("hasRole('VIEW_ALL_PERMISSIONS')")
    public Mono<ResponseEntity<Response<?>>> viewAllPermissions(){
        return permissionService.getAllMerchantPermissions()
