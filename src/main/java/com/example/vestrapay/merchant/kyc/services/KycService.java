package com.example.vestrapay.merchant.kyc.services;
...
public class KycService implements IKycService {
    ...
    @Override
    public Mono<Response<Object>> upload(Map<String, MultipartFile[]> fileList) {
                ...
                .flatMap(user -> {
                    ...
                    if (!user.getUserType().equals(UserType.MERCHANT)){
                        return Mono.just(Response.builder()
                                .data("KYC upload should be done by merchants")
