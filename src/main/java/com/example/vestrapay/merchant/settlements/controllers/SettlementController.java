package com.example.vestrapay.merchant.settlements.controllers;
...
public class SettlementController {
    ...
    @PutMapping("update")
    public Mono<ResponseEntity<Response<Settlement>>>update(@RequestBody UpdateSettlementDTO request){
    ...
    @PostMapping("primary")
    public Mono<ResponseEntity<Response<Void>>>setPrimaryAccount(@RequestBody String settlementAccountUUID){
        return settlementService.setPrimaryAccount(settlementAccountUUID)
                .map(settlementResponse -> ResponseEntity.status(settlementResponse.getStatus()).body(settlementResponse));
    }
